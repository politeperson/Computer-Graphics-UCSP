...
void init(void)
{
	...
	//Shader ourShader(
	vertexshader = initshaders(GL_VERTEX_SHADER, "B://UCSP//ComputacionGrafica//laboratorios//GLFW_GLAD_GLUT_GLEW_cmake_project//src//hw0//shaders//light.vert.glsl");
	fragmentshader = initshaders(GL_FRAGMENT_SHADER, "B://UCSP//ComputacionGrafica//laboratorios//GLFW_GLAD_GLUT_GLEW_cmake_project//src//hw0//shaders//light.frag.glsl");
#endif
...
#elif defined(_WIN32) || defined(WIN32) 
	inittexture("B://UCSP//ComputacionGrafica//laboratorios//GLFW_GLAD_GLUT_GLEW_cmake_project//src//hw0//wood.ppm", shaderprogram);
#endif
